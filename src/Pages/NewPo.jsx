        ...
        <form className="px-8 py-8 space-y-8">
          ...
          <div>
            ...
            <div className="bg-gray-50 border border-dashed border-gray-300 rounded-md min-h-[60px] flex flex-col gap-2 p-4">
              {processes.length === 0 ? (
                ...
                processes.map((proc, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 bg-white rounded shadow-sm px-3 py-2 border border-gray-100"
                  >
            ...
            <div className="text-xs text-gray-400 mt-1 pl-1">
              Select a recipe or add processes manually. (Drag-and-drop coming
              soon)
            </div>
          </div>
          {/* Submit */}
